package ir.amv.os.vaseline.ws.rest.apis.basic.layerimpl.multiparam.jaxrs;

import ir.amv.os.vaseline.basics.apis.core.shared.util.stream.StreamUtils;
 ...
 * @author Amir
 */
public interface IBaseImplementedMultiparamJsonReader extends MessageBodyReader<Object> {
