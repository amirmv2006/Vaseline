package ir.amv.os.vaseline.business.apis.multidao.server.crud;

import ir.amv.os.vaseline.data.apis.dao.server.crud.IBaseCrudDao;
import ir.amv.os.vaseline.business.apis.layer.server.crud.IBaseEntityCrudApi;
import ir.amv.os.vaseline.business.apis.multidao.server.ro.IBaseMultiDaoReadOnlyApi;
...
public interface IBaseMultiDaoCrudApi<E extends IBaseEntity<Id>, D extends IBaseDto<Id>, Id extends Serializable>
    ...
    @Override
    IBaseCrudDao getDaoFor(String category) throws BaseVaselineServerException;
}
