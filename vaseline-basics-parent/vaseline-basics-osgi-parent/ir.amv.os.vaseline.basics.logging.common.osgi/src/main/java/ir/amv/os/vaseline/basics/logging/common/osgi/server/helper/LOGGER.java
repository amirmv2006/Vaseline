package ir.amv.os.vaseline.basics.logging.common.osgi.server.helper;

import ir.amv.os.vaseline.basics.logging.api.server.constants.LoggerConstants;
...
/**
 * a class for holding static reference to {@link IVaselineLogger}
 * @author Amir
 */
public class LOGGER {
