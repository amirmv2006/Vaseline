package ir.amv.os.vaseline.data.hibernate.apis.advancedsearch.server.criteria;
...
import ir.amv.os.vaseline.data.hibernate.apis.dao.hibernatepatch.StringFunctionCriterion;
