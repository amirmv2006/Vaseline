package ir.amv.os.vaseline.data.jpa.spring.advanced.search.criteria;

import ir.amv.os.vaseline.data.basic.api.from.SearchJoinType;
import ir.amv.os.vaseline.data.advanced.search.api.criteria.IBaseCriteriaAdvancedSearchParser;
...
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.func.IBaseApplyFunctionCondition;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.logical.IMultiOperandLogicalCondition;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.logical.ISingleOperandLogicalCondition;
...
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.multiop.IMultiOperandGeneralCondition;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.multiop.MultiOperandGeneralConditionImpl;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.noop.INoOperandGeneralCondition;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.noop.NoOperandGeneralConditionImpl;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.oneop.IOneOperandComparableCondition;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.oneop.IOneOperandGeneralCondition;
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.oneop.IOneOperandStringCondition;
...
import ir.amv.os.vaseline.data.advanced.search.api.model.condition.twoop.ITwoOperandComparableCondition;
