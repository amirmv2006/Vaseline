...
import ir.amv.os.vaseline.data.advanced.search.api.model.BaseSearchObjectImpl;
...
import ir.amv.os.vaseline.data.advanced.search.maven.plugin.fqnconverter.impl.FqnEntityToSOImplConverterImpl;
...
public class ClassEntityToSOImplConverterImpl
    ...
    public ClassEntityToSOImplConverterImpl(String entBasePackage, String isoBasePackage, FqnEntityToISOConverterImpl isoConverter) {
        ...
        soImplConverter = new FqnEntityToSOImplConverterImpl(isoBasePackage, isoBasePackage + ".impl");
