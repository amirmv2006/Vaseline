package ir.amv.os.vaseline.data.basic.api.criteria;

import ir.amv.os.vaseline.basics.core.api.utils.ds.KeyStartsWithMap;
import ir.amv.os.vaseline.data.basic.api.from.IBaseCriteriaFromProvider;
