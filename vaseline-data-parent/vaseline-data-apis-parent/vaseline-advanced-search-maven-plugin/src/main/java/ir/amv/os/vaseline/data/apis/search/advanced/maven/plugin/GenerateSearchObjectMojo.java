package ir.amv.os.vaseline.data.apis.search.advanced.maven.plugin;

import ir.amv.os.vaseline.data.apis.search.advanced.maven.plugin.fqnconverter.impl.FqnEntityToISOConverterImpl;
import ir.amv.os.vaseline.data.apis.search.advanced.maven.plugin.classconverter.impl.ClassEntityToISOConverterImpl;
import ir.amv.os.vaseline.data.apis.search.advanced.maven.plugin.classconverter.impl.ClassEntityToSOImplConverterImpl;
