package ir.amv.os.vaseline.file.dao.def.common.server.dao.base.path;
 ...
 */
public interface IVaselineFilePathDao
        extends IVaselineFileDao<VaselineFilePathEntity, VaselineFilePathDto> {
}
